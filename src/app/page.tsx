            ...
            {[
              {
                ...
                desc: "Select from our beautiful collection of charm shapes",
              },
              {
                icon: ImageIcon,
                title: "Upload Your Image",
                desc: "Add your favorite photo in PNG format",
              },
              {
                icon: Sparkles,
                title: "Customize Design",
                desc: "Adjust position, zoom, and select your material",
              },
              {
                icon: ShoppingCart,
                title: "Add to Cart",
                desc: "Review and add your custom charm to cart",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
              ...
              >
                <div className="relative">
                  ...
                  <div
                    className="absolute -top-2 -right-2 w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm"
                    style={{ backgroundColor: "#D4A574", color: "#FFFFFF" }}
                  >
                    {index + 1}
                  </div>
                ...
                <div className="flex items-center space-x-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-5 h-5"
                      style={{ fill: "#D4A574", color: "#D4A574" }}
                    />
                  ))}
                </div>
                <p
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex flex-col justify-center">
                ...
                <p className="text-lg mb-6" style={{ color: "#666666" }}>
                  ...
                  jewelry inspiration delivered to your inbox.
                </p>
