          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p
                ...
                style={{ color: "#666666" }}
              >
                LuxCharms was founded with a simple yet powerful idea: everyone
                deserves to wear their most precious memories close to their
                heart. What started as a small workshop in New York has grown
                into a beloved brand serving customers worldwide.
              </p>
              <p
                className="text-lg leading-relaxed"
                style={{ color: "#666666" }}
              >
                Each charm we create is more than just jewelry—it's a story, a
                moment frozen in time, a connection to what matters most. From
                family portraits to pet photos, wedding memories to milestone
                celebrations, we help you preserve life's beautiful moments in
                exquisite detail.
              </p>
            </motion.div>
          </div>
              ...
              <div className="space-y-8">
                <div className="space-y-3">
                  ...
                  <p style={{ color: "#666666" }}>
                    925 sterling silver, renowned for its durability and
                    brilliant shine. Hypoallergenic and perfect for everyday
                    wear.
                  </p>
                </div>
                <div className="space-y-3">
                  ...
                  <p style={{ color: "#666666" }}>
                    Luxurious 18K gold plating over premium silver base. Rich,
                    warm tone that develops a beautiful patina over time.
                  </p>
                </div>
                <div className="space-y-3">
                  <h3
                  ...
                  <p style={{ color: "#666666" }}>
                    Romantic rose gold finish with copper alloy. Blends classic
            ...
            >
              <div className="flex gap-8 ">
                <div className="space-y-6">
                  <div className="rounded-2xl  flex items-center justify-center max-w-[190px]">
                    <Image
              ...
              {[
                {
                  step: "01",
                  title: "Upload Photo",
                  desc: "You upload your favorite photo in high resolution",
                  icon: Upload,
                },
                {
                  step: "02",
                  title: "Customize",
                  desc: "Choose shape, material, and perfect the positioning",
                  icon: Wand2,
                },
                {
                  step: "03",
                  title: "Craft",
                  desc: "Our artisans craft your charm with precision and care",
                  icon: Hammer,
                },
                {
                  step: "04",
                  title: "Deliver",
                  desc: "Your custom charm arrives beautifully packaged",
                  icon: Package,
                },
              ].map((item, index) => (
                <motion.div
