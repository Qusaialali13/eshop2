...
export default function Charms() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FAFAFA' }}>
      ...
      {/* Header */}
      <section className="pt-28 pb-16" style={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #FAFAFA 50%, #F5F5F5 100%)' }}>
      ...
      <section className="py-20" style={{ backgroundColor: '#FAFAFA' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4 text-center" style={{ color: '#000000' }}>
              Need Help Choosing?
            </h2>
            <p className="text-lg mb-8 max-w-xl mx-auto text-center" style={{ color: '#666666' }}>
      ...
      <div className="h-8" style={{ backgroundColor: '#000000' }} />
